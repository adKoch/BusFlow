...
class VehicleLocationMongoRepository(@Autowired val mongoTemplate: ReactiveMongoTemplate) : VehicleLocationRepository {
    ...
    override fun findAllByLinesInTimeInRect(
        lines: List<String>,
        start: LocalDateTime,
        end: LocalDateTime,
        maxLatitude: Float,
    ...
    override fun findAllInTimeInRect(
        start: LocalDateTime,
        end: LocalDateTime,
        maxLatitude: Float,
        minLatitude: Float,
    ...
    private fun getRequestedByLinesInTimeQueryInRect(
        lines: List<String>,
        start: LocalDateTime,
        end: LocalDateTime,
        maxLatitude: Float,
    ...
    private fun getRequestedInTimeQuery(
        start: LocalDateTime,
        end: LocalDateTime,
        maxLatitude: Float,
        minLatitude: Float,
